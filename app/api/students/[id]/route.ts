...
export async function PATCH(
  ...
  try {
    ...
    if (parsed.data.email !== undefined)
      userUpdates.email = parsed.data.email.toLowerCase();
    if (parsed.data.image_url !== undefined)
      userUpdates.image_url = parsed.data.image_url;
    ...
    if (parsed.data.studentId !== undefined)
      studentUpdates.student_id = parsed.data.studentId;
    if (parsed.data.feeStatus !== undefined)
      studentUpdates.fee_status = parsed.data.feeStatus;
    if (parsed.data.gender !== undefined)
      studentUpdates.gender = parsed.data.gender;
    if (parsed.data.joinDate !== undefined)
      studentUpdates.join_date = parsed.data.joinDate
        ? new Date(parsed.data.joinDate).toISOString()
        : null;
    if (parsed.data.phone !== undefined)
      studentUpdates.phone = parsed.data.phone;
